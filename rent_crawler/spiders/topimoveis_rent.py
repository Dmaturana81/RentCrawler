...
class Topimoveis(scrapy.Spider):
    ...
    def update_settings(cls, settings):
        ...
        settings.set("LOG_FILE", f'{date.today().strftime("%y_%m_%d")}_TIr_spider_log.txt', priority="spider")
    ...
    def get_prices(cls, json_source: dict) -> Prices:
        ...
        prices_loader.add_value('price', json_source.get('valLocation'))
